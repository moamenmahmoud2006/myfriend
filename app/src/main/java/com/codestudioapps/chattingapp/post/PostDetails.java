package com.codestudioapps.chattingapp.post;
...
import com.codestudioapps.chattingapp.adapter.AdapterComments;
import com.codestudioapps.chattingapp.groups.ShareGroupActivity;
import com.codestudioapps.chattingapp.model.ModelComments;
...
public class PostDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.codestudioapps.chattingapp.fileprovider", file);
